...
const ngColor kSilver(0xc0, 0xc0, 0xc0, 0xff);
const ngColor kGray(0x80, 0x80, 0x80, 0xff);
const ngColor kWhite(0xff, 0xff, 0xff, 0xff);
const ngColor kMaroon(0x80, 0x00, 0x00, 0xff);
const ngColor kRed(0xff, 0x00, 0x00, 0xff);
const ngColor kPurple(0x80, 0x00, 0x80, 0xff);
const ngColor kFuchsia(0xff, 0x00, 0xff, 0xff);
const ngColor kGreen(0x00, 0x80, 0x00, 0xff);
const ngColor kLime(0x00, 0xff, 0x00, 0xff);
const ngColor kOlive(0x80, 0x80, 0x00, 0xff);
const ngColor kYellow(0xff, 0xff, 0x00, 0xff);
const ngColor kNavy(0x00, 0x00, 0x80, 0xff);
const ngColor kBlue(0x00, 0x00, 0xff, 0xff);
const ngColor kTeal(0x00, 0x80, 0x80, 0xff);
const ngColor kAqua(0x00, 0xff, 0xff, 0xff);
const ngColor kOrange(0xff, 0xa5, 0x00, 0xff);
